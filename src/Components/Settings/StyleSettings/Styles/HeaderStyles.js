      ...
      <PanelBody title={__("Form Header", "register-form")} initialOpen={false}>
...

        {
          headerTab === "headercontent" && <Fragment>
            ...
            <div className="rgfr-panelDevice">
              <Device className='rgfr-device' value={device} onChange={value => setDevice(value)} />
              <BoxControl label={__("Margin", "register-form")} values={formHeader.header.margin[device]} onChange={value => setAttributes({ formHeader: updateData(formHeader, "header", value, "margin", device) })} />
            </div>

            <div className="rgfr-panelDevice">
              <Device className='rgfr-device' value={device} onChange={value => setDevice(value)} />
              <BoxControl label={__("Padding", "register-form")} values={formHeader.header.padding[device]} onChange={value => setAttributes({ formHeader: updateData(formHeader, "header", value, "padding", device) })} />
            </div>
...

        {
          headerTab === "logo" && <Fragment>
            ...
            <div className="rgfr-panelDevice">
              <Device className='rgfr-device' value={device} onChange={value => setDevice(value)} />
              <BoxControl label={__("Margin", "register-form")} values={formHeader.header.logo.margin[device]} onChange={value => setAttributes({ formHeader: updateData(formHeader, "header", value, "logo", "margin", device) })} />
            </div>

            <div className="rgfr-panelDevice">
              <Device className='rgfr-device' value={device} onChange={value => setDevice(value)} />
              <BoxControl label={__("Padding", "register-form")} values={formHeader.header.logo.padding[device]} onChange={value => setAttributes({ formHeader: updateData(formHeader, "header", value, "logo", "padding", device) })} />
            </div>
...

        {
          headerTab === "image" && <Fragment>
            ...
            <div className="rgfr-panelDevice">
              <Device className='rgfr-device' value={device} onChange={value => setDevice(value)} />
              <BoxControl label={__("Margin", "register-form")} values={formHeader.image.margin[device]} onChange={value => setAttributes({ formHeader: updateData(formHeader, "image", value, "margin", device) })} />
            </div>

            <div className="rgfr-panelDevice">
              <Device className='rgfr-device' value={device} onChange={value => setDevice(value)} />
              <BoxControl label={__("Padding", "register-form")} values={formHeader.image.padding[device]} onChange={value => setAttributes({ formHeader: updateData(formHeader, "image", value, "padding", device) })} />
            </div>
        ...
        <Tab options={["title", "subtitle"]} paddingX={6} value={subTab} onChange={value => setSubTab(value)} />
        {
          subTab === "title" && <Fragment>
            <div className="rgfr-panelDevice">
              <Device className='rgfr-device' value={device} onChange={value => setDevice(value)} />
              <BoxControl label={__("Margin", "register-form")} values={formHeader.header.title.margin[device]} onChange={value => setAttributes({ formHeader: updateData(formHeader, "header", value, "title", "margin", device) })} />
            </div>

            <div className="rgfr-panelDevice">
              <Device className='rgfr-device' value={device} onChange={value => setDevice(value)} />

              <BoxControl label={__("Padding", "register-form")} values={formHeader.header.title.padding[device]} onChange={value => setAttributes({ formHeader: updateData(formHeader, "header", value, "title", "padding", device) })} />
            </div>
...

        {
          subTab === "subtitle" && <Fragment>
            <div className="rgfr-panelDevice">
              <Device className='rgfr-device' value={device} onChange={value => setDevice(value)} />
              <BoxControl label={__("Margin", "register-form")} values={formHeader.header.subTitle.margin[device]} onChange={value => setAttributes({ formHeader: updateData(formHeader, "header", value, "subTitle", "margin", device) })} />
            </div>

            <div className="rgfr-panelDevice">
              <Device className='rgfr-device' value={device} onChange={value => setDevice(value)} />

              <BoxControl label={__("Padding", "register-form")} values={formHeader.header.subTitle.padding[device]} onChange={value => setAttributes({ formHeader: updateData(formHeader, "header", value, "subTitle", "padding", device) })} />
            </div>
