  ...
  return (
    <Fragment>
      <PanelBody title={__("Validation Messages", "register-form")} initialOpen={false} >
        ...
        <TextControl label={__("Successful Registration", "register-form")} value={validation.success} onChange={value => setAttributes({ validation: updateData(validation, "success", value) })} />
      </PanelBody>
    </Fragment>
  );
};
